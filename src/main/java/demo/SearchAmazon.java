...
// Enter amazon in search textfield Using Locator "ID" //textarea[@name="q"] | sendKeys"amazon"
...
// Verify that amazon.in OR amazon.com link is present on the page Using Locator "Name" //span[text()='Amazon.in'] or //span[text()='Amazon.com']
